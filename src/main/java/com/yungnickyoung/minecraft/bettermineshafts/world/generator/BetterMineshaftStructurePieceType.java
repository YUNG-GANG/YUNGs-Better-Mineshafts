...
public interface BetterMineshaftStructurePieceType extends StructurePieceType {
    ...
    StructurePieceType CUSTOM_TUNNEL = register(BetterMineshaftGenerator.CustomTunnel::new, "BMSCustomTunnel");
    StructurePieceType CUSTOM_CROSSING = register(BetterMineshaftGenerator.CustomCrossing::new, "BMSCustomCrossing");
