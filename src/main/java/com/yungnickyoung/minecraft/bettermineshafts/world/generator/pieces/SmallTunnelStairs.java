...
public class SmallTunnelStairs extends MineshaftPiece {
    ...
    public SmallTunnelStairs(int chunkPieceLen, Random random, BoundingBox blockBox, Direction direction, MineshaftVariantSettings settings) {
        super(BetterMineshaftStructurePieceType.SMALL_TUNNEL_STAIRS, chunkPieceLen, settings, blockBox);
