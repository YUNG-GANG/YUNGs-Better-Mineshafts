...
public class ColPos {
    ...
    public ColPos offset(EnumFacing facing) {
        return this.offset(facing, 1);
    }

    public ColPos offset(EnumFacing facing, int n) {
    ...
    public static class MutableColPos extends ColPos {
        ...
        public MutableColPos move(EnumFacing facing, int n) {
            return this.setPos(this.x + facing.getXOffset() * n, this.z + facing.getZOffset() * n);
        }

        public MutableColPos move(EnumFacing facing) {
