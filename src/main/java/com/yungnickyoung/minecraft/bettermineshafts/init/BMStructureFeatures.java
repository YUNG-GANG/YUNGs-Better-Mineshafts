...
public class BMStructureFeatures {
    public static StructureFeature<BetterMineshaftConfig> MINESHAFT_STRUCTURE = new BetterMineshaftStructure(BetterMineshaftConfig.CODEC);
    ...
    public static void init() {
        FabricStructureBuilder.create(new Identifier(BetterMineshafts.MOD_ID, "bettermineshaft"), MINESHAFT_STRUCTURE)
            ...
            .superflatFeature(MINESHAFT_STRUCTURE.configure(BetterMineshaftConfig.DEFAULT))
//            .adjustsSurface()
            .register();
    }
}
