...
public class BMStructureFeaturePieces {
    public static void init() {
        ...
        BetterMineshaftStructurePieceType.SURFACE_TUNNEL = Registry.register(Registry.STRUCTURE_PIECE, new Identifier(BetterMineshafts.MOD_ID, "BMSSurfaceTunnel".toLowerCase(Locale.ROOT)), SurfaceTunnel::new);
